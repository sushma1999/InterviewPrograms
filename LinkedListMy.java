...
public class LinkedListMy {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(kthFromTheEnd);
        //  LinkedListMy.Node toFind = new LinkedListMy.Node(20);
        //  System.out.println(list.IndexOf(30));
        LinkedListMy newList = new LinkedListMy();
        newList=LinkedListMy.createWithLoop();
